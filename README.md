...
<div>
  ...
  <div>
    ...
    <br />
    <p>1.  Code SandBox - <a href="https://fpmyx7.csb.app/" target="_blank" title="Profile Badge Codepen"> Form with validation and Digital Time [ Code Sand Box ]</a>.
    <p>2.  Pagination only get call - React, HTML, CSS  - <a href="https://reactpagination-alpha.vercel.app/" target="_blank" title="React Pagination">React Pagination Demo</a>.
    <p>3.  It having a CURD operation - React , HTML , CSS, node [CURD] - <a href="https://curdreactcomponent.vercel.app/" target="_blank" title="React CRUD">React CRUD Operation</a>.
    <p>4.  Its having a component splitting and powerful use of components - <a href="https://reactsearchbarversion01.vercel.app/" target="_blank" title="React Search Bar">React Search Bar</a>.
    <p>5.  Its having a react with firebase code - Runs perfectly in local [having some problem in versal] - <a href ="https://github.com/sherksiva/reactwithfirebase"  target="_blank" title="React Firebase">React            fireBase with google Login</a>.
    ...
    <9>9.  Master in Templete Edit - <a href="https://sivaprakashdashboradangularv01.vercel.app/#/dashboard" target="_blank">Sivaprakash DashBoard Angular</a>
  </div>
</div>
<!--
